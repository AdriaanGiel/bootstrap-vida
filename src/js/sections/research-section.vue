                ...
                <div class="row mb-5">
                        <div class="col-md-6">
                            <p>Voor ons onderzoek hebben we gesproken met de
                                ...
                                opdrachtgever naar voren gekomen, deze zijn hieronder
                                verder te lezen. Daarnaast hebben we ook desk research
                                gedaan, hieruit hebben we kunnen concluderen dat de
                                interactie met een robot enorm belangrijk is en dat menselijke
                        ...
                        <div class="col-md-6">
                            <p>
                                Ook hebben we gesproken met de langdurige afwezige
                                studenten die gebruik gaan maken van deze robot. Met de
                                moeite die zij in de opleiding moeten gaan steken, willen ze
                                het vooral makkelijk maken. De interactie met de robot en met
                                de app moet gemakkelijk en geleidelijk lopen. Op deze manier
                                kan de student optimaal focussen op de samenwerking en de
                                opleiding en is de robot slechts een ondersteuning.
                                De aandacht moet niet op de robot gezet worden, maar op de
                                student.
                            </p>
                        </div>
                    </div>
